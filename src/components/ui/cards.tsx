...
const events: Event[] = [
  {
    title: "Event 1 Title",
    imageUrl:
      "https://t3.ftcdn.net/jpg/01/34/53/74/360_F_134537443_VendrqyXIWyHrZgxdIsfyKUost734JDP.jpg",
    href: "./event1",
  },
  {
    title: "Event 2 Title",
...
const Card = ({ event }: CardProps) => {
  return (
    <div className="group laptop:w-[376px] tablet:w-[228.4px] relative overflow-hidden w-[32%] h-[240px] laptop:h-[448px] mb-8 rounded-lg">
      <a
        href={event.href}
      ...
      >
        <img
          src={event.imageUrl}
          alt={event.title}
          className="w-full h-[240px] object-cover laptop:h-[448px] mb-8"
        />
      </a>
